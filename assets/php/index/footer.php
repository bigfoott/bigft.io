...
<a class="fa-stack" target="_blank" href="https://twitter.com/bigfoootttt" title="Twitter">
    <i class="fas fa-stack-2x fa-square"></i>
    <i class="fab fa-stack-1x fa-twitter" style="color: white;"></i>
</a>
<a class="fa-stack" target="_blank" href="https://www.thingiverse.com/bigfoott" title="Thingiverse">
    <i class="fas fa-stack-2x fa-square"></i>
